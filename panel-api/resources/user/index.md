...
In the GdeMoi Admin Panel, a User refers to the accounts of Organizations or Individuals who are customers of the Dealer (or Sub Dealer). For example, an organization 'ABC Inc.' can be a User with the type "legal_entity," and John Doe can be a User with the type "individual."
...
The User object structure defines the attributes and details of a user account within the GdeMoi platform, including personal information, contact details, legal identifiers, and account-specific data like balance.
