...
In GdeMoi, a Dealer is an entity that acts as a reseller or distributor of the GdeMoi platform services. Dealers have access to the GdeMoi Admin Panel, where they can manage various aspects of the platform, including users, devices, and service plans.
...
* `default_user_time_zone` (string): [Time zone ID](../timezone.md) for new users created via [user/upload](../user/index.md#upload). This zone will also be selected by default when creating a new user in the GdeMoi Admin Panel.
